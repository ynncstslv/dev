...
export default function Footer() {
	return (
		<footer className="relative z-0 overflow-x-clip">
			<div className="w-[1600px] h-[400px] bottom-0 left-1/2 absolute -translate-x-1/2 bg-[#BD93F9]/15 -z-50 [mask-image:radial-gradient(50%_50%_at_bottom_center,black,transparent)]" />
